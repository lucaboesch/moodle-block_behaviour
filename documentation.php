...
echo html_writer::div(get_string('docswhatis', 'block_behaviour'), 'bigger', ['id' => 'whatis']);
echo html_writer::empty_tag('br');
...
echo html_writer::div(get_string('docshowview', 'block_behaviour'), 'bigger', ['id' => 'howview']);
echo html_writer::empty_tag('br');
...
echo html_writer::div(get_string('docshowreplay', 'block_behaviour'), 'bigger', ['id' => 'howreplay']);
echo html_writer::empty_tag('br');
...
echo html_writer::div(get_string('docshowconfig', 'block_behaviour'), 'bigger', ['id' => 'howconfig']);
echo html_writer::empty_tag('br');
echo html_writer::div(get_string('docsconfig1', 'block_behaviour'));
echo html_writer::empty_tag('br');
echo html_writer::empty_tag('br');

echo html_writer::div(get_string('docshowlord', 'block_behaviour'), 'bigger', ['id' => 'howlord']);
echo html_writer::empty_tag('br');
...
echo html_writer::div(get_string('docshowlsa', 'block_behaviour'), 'bigger', ['id' => 'howlsa']);
echo html_writer::empty_tag('br');
echo html_writer::div(get_string('docslsa1', 'block_behaviour'));
echo html_writer::empty_tag('br');
echo html_writer::empty_tag('br');

echo html_writer::div(get_string('docshowpsg', 'block_behaviour'), 'bigger', ['id' => 'howpsg']);
echo html_writer::empty_tag('br');
...
if ($context && has_capability('block/behaviour:export', $context)) {
    ...
    // Global settings.
    echo html_writer::div(get_string('docshowset', 'block_behaviour'), 'bigger', ['id' => 'howset']);
    echo html_writer::empty_tag('br');
    ...
    // Scheduled task.
    echo html_writer::div(get_string('docshowtask', 'block_behaviour'), 'bigger', ['id' => 'howtask']);
    echo html_writer::empty_tag('br');
    ...
    echo html_writer::div(get_string('docshowimport', 'block_behaviour'), 'bigger', ['id' => 'howimport']);
    echo html_writer::empty_tag('br');
    ...
    // How to delete data.
    echo html_writer::div(get_string('docshowdelete', 'block_behaviour'), 'bigger', ['id' => 'howdelete']);
    echo html_writer::empty_tag('br');
    ...
    echo html_writer::div(get_string('docshowdashboard', 'block_behaviour'), 'bigger', ['id' => 'howdashboard']);
    echo html_writer::empty_tag('br');
...
echo html_writer::div(get_string('docspublications', 'block_behaviour'), 'bigger', ['id' => 'pubs']);
echo html_writer::empty_tag('br');
